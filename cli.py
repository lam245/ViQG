...
def _evaluate(model,dataset,answer,lr, batch_size,epochs_num,path):
    ...
    train = load_json('/kaggle/input/nlp-phobart/datasets/train.parquet', dataset)
    val = load_json('/kaggle/input/nlp-phobart/datasets/valid.parquet', dataset)
    test = load_json('/kaggle/input/nlp-phobart/datasets/test.parquet', dataset)
